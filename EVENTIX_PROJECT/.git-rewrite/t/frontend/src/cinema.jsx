...
const Cinema = () => {
    ...
    return (
        <div style={{ padding: "24px", fontFamily: "sans-serif" }} className="page-enter">
            ...
            {!loading && !error && cinemaEvents.length === 0 && <p>No cinema events available.</p>}
            ...
            {!isSignedIn && !loading && (
                <div style={{
                    ...
                    <p style={{ margin: 0 }}>
                        ⚠️ Please <a href="/signin" style={{ fontWeight: "bold", color: "#007bff" }}>sign in</a> to book cinema tickets and manage your bookings.
                    </p>
                </div>
            )}
            ...
            <div style={{
                ...
                {cinemaEvents.map(event => (
                    <div key={event._id} className="event_card">
                        ...
                        <button
                            onClick={() => openBookingModal(event, quantities[event._id] || 1), scrollToTop()}
