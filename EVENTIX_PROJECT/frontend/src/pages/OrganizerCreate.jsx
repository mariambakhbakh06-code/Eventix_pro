...
const OrganizerCreate = () => {
    ...
    const [form, setForm] = useState({
        ...
        paypalEmail: ''  // ✅ ADD THIS - Organizer's PayPal email to receive payments
    });
    ...
    const handleSubmit = async (e) => {
        ...
        if (!form.paypalEmail || !emailRegex.test(form.paypalEmail)) {
            setError('Please enter a valid PayPal email address to receive payments');
            setLoading(false);
            return;
        }
        ...
        try {
            ...
            alert('Event created successfully! When tickets sell, you will receive payments to your PayPal account.');
